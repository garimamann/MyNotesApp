...
public class RandomUtils {
    ...
    private String TAG = RandomUtils.class.getSimpleName();
    ...
    public static synchronized RandomUtils getInstance() {
        ...
        return instance == null ? instance = new RandomUtils()
                : instance;
    }
    ...
    public static String getRandom(String source, int length) {
        ...
        return mValidationsUtils.isEmptyOrNull(source) ? null : getRandom(source.toCharArray(), length);
    }
